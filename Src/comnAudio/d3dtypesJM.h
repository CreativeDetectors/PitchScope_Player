...
// #include "ddraw.h"      2005JPM,    problem for new compiler   JPM
...
//  typedef HRESULT (CALLBACK* LPD3DENUMTEXTUREFORMATSCALLBACK)(LPDDSURFACEDESC lpDdsd, LPVOID lpContext);   VS2005JPM
//  typedef HRESULT (CALLBACK* LPD3DENUMPIXELFORMATSCALLBACK)(LPDDPIXELFORMAT lpDDPixFmt, LPVOID lpContext); VS2005JPM
...
/*************************************  Had to remove this on June 29, 2015  after upgraded with Visual Studio Service Pack 1 
